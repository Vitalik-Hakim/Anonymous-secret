...
<div class="row row-cards">
    ...
    <div class="col-12">
        <div class="card">
            <form method="post" action="{{ route('store_new_advertising') }}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group mb-3 row">
                        ...
                        <div class="col">
                            <textarea class="form-control @error('advertising') is-invalid @enderror" name="advertising" rows="4">{{ old('advertising') }}</textarea>
